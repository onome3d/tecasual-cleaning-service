...
const contactInfo = [
  {
    icon: Phone,
    label: "Phone",
    value: "+234 800 TECASUAL",
    subValue: "Mon-Fri 8am-6pm, Sat 9am-4pm",
  },
  {
    icon: Mail,
    label: "Email",
    value: "hello@tecasual.com",
    subValue: "Online Support 24/7",
  },
  {
    icon: MapPin,
    label: "Office",
    value: "123 Clean Street, Lagos",
    subValue: "Visit us for a consultation",
  },
  {
    icon: Clock,
    label: "Working Hours",
...
const faqs = [
  {
    ...
    a: "You can book through our contact form, call us directly, or send us a WhatsApp message. We'll respond within 2 hours during business hours.",
  },
  {
    q: "Are your staff vetted?",
    a: "Yes! All our team members undergo thorough background checks, training, and are fully insured for your peace of mind.",
  },
  {
    q: "What areas do you serve?",
    a: "We currently serve Lagos and surrounding areas. Contact us to check if we cover your location.",
  },
  {
    q: "Can I reschedule my booking?",
    a: "Absolutely! You can reschedule up to 24 hours before your appointment at no extra charge.",
  },
];
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div
          className="absolute top-40 left-10 w-24 h-24 bg-accent/20 rounded-full blur-xl animate-bounce hidden md:block"
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div
              className="inline-flex items-center gap-2 bg-primary/10 backdrop-blur-md px-5 py-2 rounded-full text-primary text-xs font-bold mb-8 border border-primary/20 animate-fade-in tracking-[0.2em] uppercase"
            ...
            <h1
              className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 md:mb-8 animate-fade-in tracking-tight leading-[1.1]"
            ...
            <p
              className="text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed animate-fade-in font-light"
              style={{ animationDelay: "0.6s", animationFillMode: "both" }}
            >
              Ready to experience the TECASUAL difference? Contact us today for
              a free consultation or to book your first service.
            </p>
          </div>
        </div>
      </section>
            ...
            {contactInfo.map((item, index) => (
              <AnimatedSection key={index} delay={index * 100}>
                <div className="bg-card/90 backdrop-blur-xl rounded-2xl md:rounded-[2rem] p-5 md:p-8 shadow-xl border border-border/50 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 hover:-translate-y-2 group h-full">
                  ...
                  <h3 className="font-bold text-base md:text-xl mb-1 md:mb-2 tracking-tight">
                    {item.label}
                  </h3>
                  <p className="text-primary font-semibold text-sm md:text-lg mb-1">
                    {item.value}
                  </p>
              ...
              <div className="bg-card rounded-2xl md:rounded-[2.5rem] p-6 md:p-8 lg:p-12 border border-border shadow-2xl relative overflow-hidden">
                ...
                {submitted ? (
                  <div className="text-center py-12 md:py-20 animate-fade-in">
                    ...
                    <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4 tracking-tight">
                      Message Sent!
                    </h2>
                    <p className="text-lg md:text-xl text-muted-foreground mb-8 md:mb-10 max-w-md mx-auto leading-relaxed">
                      Thank you for contacting TECASUAL. We&apos;ll get back to
                      you within 2 hours during business hours.
                    </p>
                    <Button
                      onClick={() => setSubmitted(false)}
                      size="lg"
                      className="rounded-full px-8 md:px-10 h-12 md:h-14 text-base md:text-lg font-bold"
                    >
                  ...
                  <>
                    <div className="mb-8 md:mb-10 relative z-10">
                      <h2 className="font-serif text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 tracking-tight">
                        Book a Service
                      </h2>
                    ...
                    >
                      <div className="grid sm:grid-cols-2 gap-6 md:gap-8">
                        <div className="space-y-2 md:space-y-3">
                          ...
                          <Input
                            ...
                            required
                            className="h-12 md:h-14 rounded-xl md:rounded-2xl bg-secondary/30 border-border/50 focus:bg-background transition-colors text-base md:text-lg px-4 md:px-6"
                          />
                        </div>
                        <div className="space-y-2 md:space-y-3">
                          <Label
                      ...
                      <div className="space-y-2 md:space-y-3">
                        ...
                        <Textarea
                          id="message"
                          placeholder="Tell us more about your needs, special requirements, or questions..."
                          rows={4}
                          className="rounded-xl md:rounded-2xl bg-secondary/30 border-border/50 focus:bg-background transition-colors text-base md:text-lg p-4 md:p-6 resize-none"
                        />
                      </div>
                      ...
                      <Button
                        type="submit"
                        size="lg"
                        className="w-full rounded-full h-14 md:h-16 text-base md:text-xl font-bold shadow-lg hover:shadow-primary/25 transition-all duration-300 hover:scale-[1.01]"
                        disabled={isSubmitting}
                      >
                        {isSubmitting ? "Sending..." : "Send Message"}
                        {!isSubmitting && (
                          <Send className="ml-3 w-5 h-5 md:w-6 md:h-6" />
                        )}
                      </Button>
                    </form>
                  </>
            ...
            <div className="lg:col-span-2 space-y-6 md:space-y-10">
              <AnimatedSection delay={100}>
                <div className="relative rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-2xl h-64 md:h-80 group">
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-black/80 to-transparent flex items-end p-6 md:p-8">
                    <p className="text-white font-semibold text-lg md:text-2xl leading-tight">
              ...
              <AnimatedSection delay={200}>
                <div className="bg-primary text-primary-foreground rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 shadow-xl relative overflow-hidden">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold font-serif mb-6 md:mb-8 relative z-10 tracking-tight">
                    Quick Contact
                  </h3>
                  <div className="space-y-3 md:space-y-4 mb-8 md:mb-10 relative z-10">
                    <a
                      href="tel:+234800TECASUAL"
                      className="flex items-center gap-4 md:gap-5 p-3 md:p-4 bg-white/10 rounded-xl md:rounded-2xl hover:bg-white/20 transition-all duration-300 border border-white/10 hover:-translate-y-1"
                    >
                    ...
                    <a
                      href="https://wa.me/234800TECASUAL"
                      className="flex items-center gap-4 md:gap-5 p-3 md:p-4 bg-white/10 rounded-xl md:rounded-2xl hover:bg-white/20 transition-all duration-300 border border-white/10 hover:-translate-y-1"
                    >
                    ...
                    <a
                      href="mailto:hello@tecasual.com"
                      className="flex items-center gap-4 md:gap-5 p-3 md:p-4 bg-white/10 rounded-xl md:rounded-2xl hover:bg-white/20 transition-all duration-300 border border-white/10 hover:-translate-y-1"
                    >
                  ...
                  <div className="border-t border-white/20 pt-6 md:pt-8 relative z-10">
                    <h4 className="font-semibold mb-4 md:mb-6 text-sm md:text-base">
                      Follow Us
                    </h4>
                    <div className="flex gap-3 md:gap-4">
                      {[Instagram, Facebook, Twitter].map((Icon, i) => (
                        <a
                          key={i}
                          href="#"
                          className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-white hover:text-primary transition-all duration-300 hover:scale-110 hover:rotate-6"
                        >
              ...
              <AnimatedSection delay={300}>
                <div className="bg-secondary/30 rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 border border-border/50">
                  ...
                  <p className="text-muted-foreground mb-6 md:mb-8 text-base md:text-lg leading-relaxed">
                    Existing clients can log in to manage bookings, view
                    history, and access exclusive offers.
                  </p>
                  <Button
                    variant="outline"
                    className="w-full rounded-full h-12 md:h-14 text-base md:text-lg border-2 hover:bg-primary hover:text-white hover:border-primary transition-all duration-300 font-bold"
                  >
                    Access Portal
                  </Button>
                </div>
      ...
      <section className="py-16 md:py-32 bg-secondary/20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6 tracking-tight">
            ...
            {faqs.map((faq, index) => (
              <AnimatedSection key={index} delay={index * 100}>
                <div className="bg-card rounded-2xl md:rounded-[2rem] p-6 md:p-8 border border-border/50 hover:shadow-xl hover:shadow-primary/10 transition-all duration-500 hover:-translate-y-2 h-full group">
                  <h3 className="font-bold text-lg md:text-xl mb-3 md:mb-4 text-primary tracking-tight group-hover:text-primary/80 transition-colors">
                    {faq.q}
                  </h3>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <AnimatedSection>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold mb-6 md:mb-8 tracking-tight">
                Visit Our Office
              </h2>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 md:mb-12 leading-relaxed font-light">
                We welcome you to visit our office for consultations, to meet
                our team, or to discuss custom service packages. Walk-ins are
                ...
                <div className="flex items-start gap-4 md:gap-6 group">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-base md:text-lg">
                      123 Clean Street, Victoria Island, Lagos, Nigeria
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4 md:gap-6 group">
              ...
              <div className="relative rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-2xl h-80 md:h-[500px] group">
                ...
                <div className="absolute inset-0 bg-linear-to-t from-black/80 via-transparent to-transparent flex items-end p-6 md:p-10">
                  <div className="text-white">
                    <div className="font-bold text-2xl md:text-3xl mb-2 tracking-tight">
                      TECASUAL Office
                    </div>
                    <div className="opacity-90 text-base md:text-xl">
      ...
      <section className="py-20 md:py-32 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          <AnimatedSection>
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-8 tracking-tight">
              Ready to Get Started?
            </h2>
            <p className="text-lg md:text-xl lg:text-2xl opacity-80 mb-10 md:mb-12 max-w-2xl mx-auto font-light leading-relaxed">
              Experience the TECASUAL difference today. Book your first service
              and see why hundreds of clients trust us with their homes.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              <a href="tel:+234800TECASUAL">
                <Button
                  size="lg"
                  variant="secondary"
                  className="rounded-full px-10 md:px-12 py-6 md:py-8 text-base md:text-xl text-primary font-bold shadow-2xl hover:scale-105 transition-all duration-300 w-full sm:w-auto"
                >
                  <Phone className="mr-2 md:mr-3 w-5 h-5 md:w-6 md:h-6" /> Call
                  Now
                </Button>
              </a>
              <a href="https://wa.me/234800TECASUAL">
                ...
                >
                  <MessageCircle className="mr-2 md:mr-3 w-5 h-5 md:w-6 md:h-6" />{" "}
                  WhatsApp Us
                </Button>
              </a>
            </div>

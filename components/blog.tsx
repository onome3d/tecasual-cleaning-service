...
const posts = [
  {
    ...
    excerpt: "Discover time-saving cleaning strategies that will help you maintain a spotless home.",
  ...
  },
  {
    ...
    excerpt: "Learn why switching to eco-friendly cleaning products is better for your family.",
    category: "Products",
    date: "May 10, 2025",
  ...
  },
  {
    ...
    excerpt: "A comprehensive guide to creating the perfect deep cleaning schedule.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Stay updated with the latest cleaning tips and industry insights from our experts
          </p>
        </div>

    ...
    <section id="contact" className="py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">Get In Touch</h2>
          <p className="text-muted-foreground text-lg">
            Ready to experience the best cleaning service? Contact us today for a free quote.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="bg-card rounded-2xl p-6 md:p-8 border border-border space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="message" placeholder="Tell us about your cleaning needs..." rows={4} required />
              </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="rounded-2xl overflow-hidden h-48 lg:h-64">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/v0_image-2-cdtofVtMrknE3PhHwku6l60NwE6Nej.png" alt="Contact us" className="w-full h-full object-cover" />
            </div>
